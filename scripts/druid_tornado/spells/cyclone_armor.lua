...
local cyclone_menu_elements_base =
{
...
local function menu()
    ...
    if cyclone_menu_elements_base.main_tab:push("Cyclone Armor") then
        cyclone_menu_elements_base.main_boolean:render("Enable Spell", "")
 
         if cyclone_menu_elements_base.main_boolean:get() then
            cyclone_menu_elements_base.min_max_targets:render("Min hits", "Amount of targets to cast the spell")
         end

         cyclone_menu_elements_base.main_tab:pop()
    end
end
...
local function logics()
    ...
    local menu_boolean = cyclone_menu_elements_base.main_boolean:get();
    ...
    if units < cyclone_menu_elements_base.min_max_targets:get() then
        return false;
    end;
