...
local function menu()
    if tornado_menu.tree_tab:push("Tornado")then
        tornado_menu.main_boolean:render("Enable Spell", "")
  
        tornado_menu.tree_tab:pop()
     end
end
...
local function logics(target)
    ...
    local menu_boolean = tornado_menu.main_boolean:get();
