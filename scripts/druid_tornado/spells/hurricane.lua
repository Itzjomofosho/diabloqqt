...
local function menu()
    if hurricane_menu_elements.tree_tab:push("Hurricane")then
       hurricane_menu_elements.main_boolean:render("Enable Spell", "")
 
       hurricane_menu_elements.tree_tab:pop()
    end
end
...
local function logics(player_position)
    ...
    local menu_boolean = hurricane_menu_elements.main_boolean:get();
