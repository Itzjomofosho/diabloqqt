...
local grizzly_rage_menu_elements = 
{
...
local function menu()                                                                              
    if grizzly_rage_menu_elements.main_tab:push("Grizzly Rage")then
       grizzly_rage_menu_elements.main_boolean:render("Enable Spell", "")
 
       grizzly_rage_menu_elements.main_tab:pop()
    end
end
...
local function logics()
    ...
    local menu_boolean = grizzly_rage_menu_elements.main_boolean:get();
