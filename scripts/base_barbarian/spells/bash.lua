...
local menu_elements_bash_base =
{
    ...
    spell_range       = slider_float:new(0.5, 3.0, 2.50, get_hash(my_utility.plugin_label .. "bash_spell_range_")),
    max_angle       = slider_int:new(45, 180, 120, get_hash(my_utility.plugin_label .. "bash_spell_max_angle"))
}
