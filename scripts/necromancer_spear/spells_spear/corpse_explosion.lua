...
local menu_elements = {
    ...
    corpse_explosion_boolean      = checkbox:new(true, get_hash(my_utility.plugin_label .. "corpse_explosion_boolean_blight")),
    corpse_explosion_mode         = combo_box:new(0, get_hash(my_utility.plugin_label .. "corpse_explosion_cast_modes_blight")),
    corpse_explosion_logic        = combo_box:new(0, get_hash(my_utility.plugin_label .. "corpse_explosion_logic_blight")),
    effect_size_affix_mult   = slider_float:new(0.0, 100.0, 0.0, get_hash(my_utility.plugin_label .. "corpse_explosion_effect_size_affix_mult_blight")), -- Slider from 0.0 to 100.0
}
...
local function logics()
    ...
    local is_logic_allowed = my_utility.is_spell_allowed(
                ...
                corpse_explosion_id,
                menu_elements.corpse_explosion_mode:get());
