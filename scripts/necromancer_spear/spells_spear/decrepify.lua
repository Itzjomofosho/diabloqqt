...
local menu_elements = {
    ...
    decrepify_boolean           = checkbox:new(true, get_hash(my_utility.plugin_label .. "decrepify_boolean_blight")),
    decrepify_mode              = combo_box:new(0, get_hash(my_utility.plugin_label .. "decrepify_cast_modes_blight")),
    min_hits_slider             = slider_int:new(0, 30, 5, get_hash(my_utility.plugin_label .. "decrepify_min_hits_slider_blight")),

    allow_elite_single_target   = checkbox:new(true, get_hash(my_utility.plugin_label .. "allow_elite_single_target_blight")),
    effect_size_affix_mult      = slider_float:new(0.0, 100.0, 0.0, get_hash(my_utility.plugin_label .. "decrepify_effect_size_affix_mult_slider_blight")),
}
...
local corpse_explosion_ = require("spells_spear/corpse_explosion");
...
local function logics()
    ...
    local is_logic_allowed = my_utility.is_spell_allowed(
                ...
                decrepify_spell_id,
                menu_elements.decrepify_mode:get());
