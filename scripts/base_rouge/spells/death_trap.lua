...
local menu_elements_death_trap =
{
    ...
    min_percentage_hits   = slider_float:new(0.1, 1.0, 0.60, get_hash(my_utility.plugin_label .. "min_percentage_hits_trap_base")),
    soft_score            = slider_float:new(2.0, 15.0, 7.0, get_hash(my_utility.plugin_label .. "min_percentage_hits_trap_base_soft_core")),

    spell_range   = slider_float:new(1.0, 15.0, 2.50, get_hash(my_utility.plugin_label .. "death_trap_spell_range")),
    spell_radius   = slider_float:new(0.50, 10.0, 5.50, get_hash(my_utility.plugin_label .. "death_trap_spell_radius")),
}
