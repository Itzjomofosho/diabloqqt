...
local menu_elements =
{
    ...
    min_hits              = slider_int:new(1, 20, 3, get_hash(my_utility.plugin_label .. "smoke_grenade_base_min_hits_to_casttrap_base_pos")),
    
    allow_percentage_hits = checkbox:new(true, get_hash(my_utility.plugin_label .. "allow_percentage_hits_smoke_grenade_base_pos")),
    min_percentage_hits   = slider_float:new(0.1, 1.0, 0.45, get_hash(my_utility.plugin_label .. "min_percentage_hits_smoke_grenade_base_pos")),
    ...
    spell_range   = slider_float:new(1.0, 10.0, 3.50, get_hash(my_utility.plugin_label .. "smoke_grenade_spell_range")),
    spell_radius   = slider_float:new(0.50, 5.0, 3.50, get_hash(my_utility.plugin_label .. "smoke_grenade_spell_radius")),
}
...
local function logics(entity_list, target_selector_data, best_target)
    ...
    local player_position = get_player_position()
    local is_wall_collision = prediction.is_wall_collision(player_position, cast_position, 1.0);
