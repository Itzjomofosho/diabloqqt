...
local menu_elements = {
    ...
    effect_size_affix_mult   = slider_float:new(0.0, 100.0, 0.0, get_hash(my_utility.plugin_label .. "corpse_explosion_effect_size_affix_mult_base")), -- Slider from 0.0 to 100.0
}
