...
local menu_elements_iron_maiden_base = {
    ...
    effect_size_affix_mult      = slider_float:new(0.0, 100.0, 0.0, get_hash(my_utility.plugin_label .. "iron_maiden_effect_size_affix_mult_slider_base")),
}
